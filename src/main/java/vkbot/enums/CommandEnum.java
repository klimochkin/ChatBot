...
public enum CommandEnum implements MessageTypeEnum{
    ...
    FIND        ("видео",   "👉 видео <текст для поиска> - поиск видео"),
    SEARCH      ("найди",   "👉 найди <текст для поиска> - поиск по интернету"),
    ...
    STAT_MSG    ("топ1",    "👉 топ1 - статистика по числу сообщений в чате"),
    STAT_CHR    ("топ2",    "👉 топ2 статистика по числу символов в сообщениях в чате"),
    DETECTOR    ("чсв",     "👉 чсв - детектор самолюбия");
